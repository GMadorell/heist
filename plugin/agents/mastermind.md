...
Run `heist validation resolve <path>` when spawned for repo conventions (build/lint/test commands, main branch name) — use it to ground constraints and out-of-scope calls, not to re-discover it yourself.
